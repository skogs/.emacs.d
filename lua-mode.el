...
(defvar lua-font-lock-syntactic-keywords
  ;; [bhk 22-mar-09] try to handle long strings and comments in jit-lock-mode
  ;; black magic borrowed from sgml-mode
  '(("\\(\\[\\)=*\\[" (1 "< b"))
    ("\\]=*\\(\\]\\)" (1 "> b")))
  "Syntactic keywords for `lua-mode'.")
  ...
  (let ((switches nil)
    ...
    (set (make-local-variable 'font-lock-defaults)
         '(lua-font-lock-keywords nil nil ((?_ . "w"))
           nil (font-lock-syntactic-keywords
                . lua-font-lock-syntactic-keywords)))
